...
load('/Users/govinda/Desktop/Project/data/static_SC-FC/NKI_Rockland/mat files/SC-FC.mat'); % 188 regions, loading all good subjects working with version1.
if (exist('all_Emp_SC'))
    sCall = all_Emp_SC;
    fCall = all_Emp_FC;
end
...
save('/Users/govinda/Desktop/Project/results/static SC-FC/MKL_version3/single_scale_corr_vals_188.mat');

%% checking for descrepancies in regions in the subjects
high_scl_subjs = find(max_scl .* (max_scl > 9.0));
low_scl_subjs  = find(max_scl .* (max_scl < 3.0));
